...
class SettingsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $maxFileSize = (int) Setting::getValue('charges_max_file_size', '5');

        return view('settings.index', compact('refreshInterval', 'chargePeriod', 'maxFileSize'));
    }
    ...
    public function update(Request $request)
    {
        ...
        Setting::setValue('charges_max_file_size', (string) $data['max_file_size']);
