<form id="createResolutionForm" method="POST" action="{{ route('resolucions.store') }}" enctype="multipart/form-data">
    ...
    <div class="modal-body px-4">
        ...
        <div class="card form-section-card mb-4" id="create_res_sec_1">
            <div class="card-body p-3">
                <div class="d-flex align-items-center mb-3">
                    <span class="material-symbols-outlined text-primary me-2">account_tree</span>
                    <h6 class="text-primary fw-bold mb-0">1. Categorización Principal</h6>
                </div>
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <select name="resolucion_type_id" class="form-select border-primary-subtle bg-white" id="create_resolution_type">
        ...
        <div class="card form-section-card mb-4" id="create_res_sec_2">
            <div class="card-body p-3">
                <div class="d-flex align-items-center mb-3">
                    <span class="material-symbols-outlined text-primary me-2">group_add</span>
                    <h6 class="text-primary fw-bold mb-0">2. Destinatarios / Interesados</h6>
                </div>
        ...
        <div class="card form-section-card mb-4" id="create_res_sec_3">
            <div class="card-body p-3">
                <div class="d-flex align-items-center mb-3">
                    <span class="material-symbols-outlined text-primary me-2">edit_document</span>
                    <h6 class="text-primary fw-bold mb-0">3. Detalles del Documento</h6>
                </div>
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control text-uppercase fw-bold" name="rd" id="create_resolution_rd"
                                placeholder="EJ: 001 O 001-2026" value="{{ old('rd') }}">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <select name="asunto_type_id" class="form-select border-primary-subtle bg-white" id="create_asunto_type" disabled>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-12">
                        ...
                        <textarea class="form-control text-uppercase" name="asunto" id="create_resolution_asunto" rows="2"
                            placeholder="INGRESE DETALLES ADICIONALES (OPCIONAL)">{{ old('asunto') }}</textarea>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const sec1 = document.getElementById('create_res_sec_1');
        const sec2 = document.getElementById('create_res_sec_2');
        const sec3 = document.getElementById('create_res_sec_3');

        // Campos obligatorios de cada sección
        const sec1Fields = () => [document.getElementById('create_resolution_type')];
        const sec2HasInteresados = () => {
            const container = document.getElementById('hidden_interesados_inputs');
            if (!container) return false;
            const inputs = container.getElementsByTagName('input');
            return inputs.length > 0;
        };
        const sec3Fields = () => [
            document.getElementById('create_resolution_rd'),
            document.getElementById('create_resolution_fecha'),
            document.getElementById('create_asunto_type'),
            document.getElementById('create_resolution_asunto')
        ];
        ...
        const hiddenContainer = document.getElementById('hidden_interesados_inputs');
        if (hiddenContainer) {
            const observer = new MutationObserver(checkValidity);
            observer.observe(hiddenContainer, { childList: true });
        }

        // Ejecutar validación inicial al abrir el modal o cargar
        setTimeout(checkValidity, 500);

        // Re-evaluar cuando se abra el modal (para resetear estados)
