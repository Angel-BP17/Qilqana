    <div class="tab-pane fade {{ ($active ?? false) ? 'show active' : '' }}" id="resolution-tab-pane" role="tabpanel" aria-labelledby="resolution-tab"
            tabindex="0">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <div class="d-none d-md-flex gap-2 align-items-center">
                                <form class="d-flex flex-wrap gap-2 row" action="{{ route('charges.index') }}"
                                    ...
                                    <div class="col-2">
                                        <select name="resolution_period" class="form-select"
                                ...
                                <form action="{{ route('charges.reports.resolution') }}" method="GET">
                                    ...
                                    @endif
                                    @if ($resolutionPeriod)
                                        <input type="hidden" name="resolution_period"
